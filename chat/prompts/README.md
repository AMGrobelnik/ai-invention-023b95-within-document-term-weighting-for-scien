...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_evaluation_1.md` — 10 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 13 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_evaluation_1.md` — 4 prompts
